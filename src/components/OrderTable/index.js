...
import { itemApi } from "../Helper/item";
...
function OrderTable() {
  ...
  const fetchitemlist = () => {
    ItemCustomerList().then(
      (res) => {
        ...
        console.log("customerLive", itemlistLive);
      },
      (err) => {
        // console.log(err);
      }
  ...
  const handleSubmit = async (event) => {
    ...
    if (formm.checkValidity() === false) {
      ...
      if (selectedCustomer && selectedCustomer != "0") {
        ...
        // let isComplete = [];
        // formFields.map((e) => {
        //   itemId.push(e.itemId);
        //   charges.push(e.charges);
        //   types.push(e.type);
        //   orderItemIds.push(e.orderItemId);
        //   isComplete.push(e.isComplete == true ? "1" : "0")
        // });
  ...
  const handleFormChange = (event, index, item = "") => {
    ...
    let data = [...formFields];
    data[index][item !== "" ? item : event.target.name] =
      item !== "" ? event.value : event.target.value;
    setFormFields(data);
    // if (event.target.name["charges"] === event.target.value[0]) {
    ...
    <div>
      ...
      <CRow className="justify-content-center">
                ...
                >
                  <CRow className="mb-3">
                    <CCol md={7} sm={12} xs={12}>
                      ...
                      &nbsp;&nbsp;
                      <div class="avatar bg-primary avatar-sm text-white">
                        <label
                    ...
                    <CCol md={4} sm={12}>
                      ...
                      {/* <CFormFeedback  invalid className="itemError">
                                Please Select Date
                              </CFormFeedback> */}
                    </CCol>
                          ...
                          <CCol md={5} sm={12} xs={11} className="input-item">
                            ...
                            <div className="">
                              {/* <Select
                                ...
                                value={itemorderList?.find(
                                  (obj) => obj.value === form.item
                                )}
                                onChange={(event) =>
                            ...
                            {/* <CFormLabel htmlFor="validationCustom01" className="mb-2"> 
                            Item
                          </CFormLabel>
                          <CFormInput
                            type="text"
        ...
        <CFormLabel htmlFor="validationCustom03" >Total Charges :</CFormLabel>
                    ...
                    <CCol md={4} sm={12} xs={10} className="total-Charges">
