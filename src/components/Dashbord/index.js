  ...
  const columns = [
    ...
    },
    {
      ...
      selector: (row) => (<>
        {row.smsSendFlag !== "0" ? (
          <>
            <h6 className="badge p-1" style={{ backgroundColor: "lightgreen", color: "#006400", fontSize: "0.7rem" }}>
              Message Sent </h6>
          </>
        ) : <span className="badge p-1 " style={{ backgroundColor: "lightpink", color: "red", fontSize: "0.7rem" }}> Not Sent</span>
        }&nbsp;
      </>)
    },
    {
  ...
  return (
    <div>
     ...
     <CCard style={{margin:"10px"}} className="mb-4">
        ...
        <CContainer fluid>
          <CRow className="mb-0">
            <CCol sm={12} lg={12} xs={12} className='title-Dashboard'>
              <h5 className="main-title  mt-0">Dashboard </h5>
            </CCol>
            {/* <CCol xs={8}>
              <CBreadcrumb
                className="m-0 ms-2"
              ...
              <CCard className="mt-3">
                <div class="p-3">
                  ...
                  <div className="d-flex justify-content-between">
                    <p className="mt-2 ">
                    <div class="avatar bg-primary text-white" style={{width: "3rem",height: "3rem"}}> 
                    <h2 className="">{customers}</h2>
                    </div>
                    
                    </p>
                    <Link to="/customer" className="">
                      {/* <CButton color="secondary" title="View Customers" variant="outline" className="w-5"> */}
                        {/* <CIcon icon={cilFolderOpen} size="lg" /> */}
                        View
                      {/* </CButton> */}
                    </Link>
            ...
            <CCol xs={12} sm={12} lg={3}>
              <CCard className="mt-3">
                <div className="p-3 ">
                  ...
                  <div className="d-flex justify-content-between">
                    <p className="mt-2">
                    <div class="avatar bg-info text-white" style={{width: "3rem",height: "3rem"}}> 
                    <h2 className="">{orders}</h2>
                    </div>
                    
                    </p>
                    <Link to="/customerbilling">
                      {/* <CButton color="secondary" title="View Orders" variant="outline" className="w-5"> */}
                        {/* <CIcon icon={cilFolderOpen} size="lg" /> */}
                         View
                      {/* </CButton> */}
                    </Link>
            ...
            <CCol xs={12} sm={12} lg={3}>
              <CCard className="mt-3">
                <div className="p-3 ">
                  ...
                  <div className="d-flex justify-content-between">
                    <p className="mt-2">
                    <div class="avatar bg-warning text-white" style={{width: "3rem",height: "3rem"}}> 
                    <h2 className="">{todaysOrders}</h2>
                    </div>
                    
                    </p>
                    <Link to="/customerbilling">
                      {/* <CButton color="secondary" title="View Today's Orders" variant="outline" className="w-5"> */}
                        {/* <CIcon icon={cilFolderOpen} size="lg" /> */}
                         View
                      {/* </CButton> */}
                    </Link>
            ...
            <CCol xs={12} sm={12} lg={3}>
              <CCard className="mt-3">
                <div className="p-3 ">
                  ...
                  <div className="d-flex justify-content-between">
                    <p className="mt-2">
                    <div class="avatar bg-danger text-white" style={{width: "3rem",height: "3rem"}}> 
                    <h2 className=" ">{unpaidBill}</h2>
                    </div>
                    
                    </p>
                    <Link to="/totaloutstanding">
                      {/* <CButton color="secondary" title="View Unpaid Bills" variant="outline" className="w-5"> */}
                        {/* <CIcon icon={cilFolderOpen} size="lg" /> */}
                         View
                      {/* </CButton> */}
                    </Link>
