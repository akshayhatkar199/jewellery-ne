...
import Totalorderpay from "./components/Totalorderpay/index"
    ...
    <div>
      <BrowserRouter basename={"/cplasersoldering/testing"}>
        <Routes>
          ...
          <Route path="/totalorderpay" element={<RequireAuth><Layout><Totalorderpay /></Layout></RequireAuth>} />
          {/* <Route path="/itempage" element={<RequireAuth><Layout><Itempage /></Layout></RequireAuth>} /> */}
        </Routes>
      </BrowserRouter>
    </div>
  );
